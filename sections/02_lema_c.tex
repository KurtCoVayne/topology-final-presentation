...
\begin{frame}{Lema C — Verificación de la homotopía}
  ...
  \begin{align*}
    ...
    K(1,s) &= \gamma\!\left(\frac{4-s-2}{2-s}\right)
             = \gamma\!\left(\frac{2-s}{2-s}\right)
             = \gamma(1) = \xo \checkmark
  \end{align*}

  \medskip
  \textbf{Continuidad en $t = \dfrac{s+1}{4}$ (frontera entre $\alpha$ y $\beta$):}
  \[
    \text{pieza 1: }\alpha\!\left(\frac{4\cdot\frac{s+1}{4}}{s+1}\right)
                 = \alpha(1) = \xo
    \qquad
    \text{pieza 2: }\beta\!\left(4\cdot\frac{s+1}{4} - 1 - s\right)
                 = \beta(0) = \xo \checkmark
  \]

  \medskip
  \textbf{Continuidad en $t = \dfrac{s+2}{4}$ (frontera entre $\beta$ y $\gamma$):}
  \[
    \text{pieza 2: }\beta\!\left(4\cdot\frac{s+2}{4}-1-s\right)
                 = \beta(1) = \xo
    \qquad
    \text{pieza 3: }\gamma\!\left(\frac{4\cdot\frac{s+2}{4}-s-2}{2-s}\right)
                 = \gamma(0) = \xo \checkmark
  \]

  Las tres piezas son continuas y coinciden en las fronteras.
  Por el \textbf{Lema de Continuidad} (aplicado dos veces), $K$ es continua.
\end{frame}
